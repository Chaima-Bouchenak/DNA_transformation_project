...
class Steps:
    ...
    def compression_process_without_bwt(self, sequence:str) -> dict:
        ...
        compression_results['First Step: The Huffman tree of each letter frequency'] = huffman_tree.__str__()
        compression_results['Second Step: Binary sequence (Keep up, you are all most done !)'] = self.huffman_object.sequence_to_binary
        compression_results['Third Step: Magic unicode'] = self.huffman_object.unicode_sequence
